...
- Plugin version: **0.4.1** (was 0.1.0 at the start of the roadmap; v0.4.x keeps image-first generation the only active path).
...
- Both `deckit-dev inspect` and `inspect-marketplace` pass with the v0.4.1 manifest.
